...
var GroupQuestsService = /** @class */ (function () {
    function GroupQuestsService(groupQuestsRepository) {
        this.groupQuestsRepository = groupQuestsRepository;
    }
    GroupQuestsService.prototype.getGroupQuests = function (disciplinas) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.groupQuestsRepository.getGroupQuests(disciplinas)];
                    case 1:
                        questoes = _a.sent();
